...
|            原模型常规剪枝(比例为0.7)             | 50| |    |     |      | |  |                       全精度                       |
|            原模型常规剪枝(比例为0.7)+finutune             | 50| |    |     |      | |  |                       全精度                       |
|            原始模型常规剪枝(比例为0.7)+规整剪枝(通道数为8)             | 50| |    |     |      | |  |                       全精度                       |
|            原始模型常规剪枝(比例为0.7)+规整剪枝(通道数为8)+finetune             | 50| |    |     |      | |  |                       全精度                       |
...
| :-------------------------: |:---:|:----: | :----: | :-----: | :------: | :----: | :---: |
|        原始的卷积        | 50| 88.41%|  0.34  |   2.56 |   10.8   |  ***   |  ***  | 
|        原始的深度可分离卷积        | 50|87.35% |  0.15  |  1.48   |   6.3   |  42%   |  1.06% |     
|  深度可分离卷积+对应的1*1卷积通道倍增  | 50| 87.72%| 0.30   | 2.97   |  6.3    | 42% | 0.69% |  
