...
class Tnn_Bin_Conv2d(nn.Module):
    ...
    def __init__(self, input_channels, output_channels,
            kernel_size=-1, stride=-1, padding=-1, dropout=0, groups=1, channel_shuffle=0, shuffle_groups=1, last_relu=0, A=2, W=2):
        ...
        self.bn = bn.BatchNorm2d_bin(output_channels, momentum=0.1, affine_flag=2)#自定义BN-可设置gamma=1,beta-train(affine_flag=1)
...
class Net(nn.Module):
    def __init__(self, cfg = None, A=2, W=2):
        ...
        self.tnn_bin = nn.Sequential(
                ...
                Tnn_Bin_Conv2d(cfg[6], cfg[7], kernel_size=1, stride=1, padding=0, groups=8, channel_shuffle=1, shuffle_groups=32, last_relu=1, A=A, W=W),
